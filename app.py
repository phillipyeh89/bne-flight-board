...
# ─────────────────────────────────────────────
#  4. UI SETUP & FRAGMENT EXECUTION (V12.46)
# ─────────────────────────────────────────────
...
def _live_dashboard_impl():
    ...
    # never prevent the flight list below from rendering (V12.46 — a broken
    ...
    for f in deduped_flights:
        ...
        # Split by data quality (V12.46 fix for the stuck-"On Ground" bug):
    ...
    st.markdown(
        f"<div style='text-align:center; color:{t.text_muted}; font-size:0.65em; margin-top:20px;'>Dev: Phillip Yeh | V12.46</div>",
        unsafe_allow_html=True,
    )
