...
<style>
    ...
    .gate-text { font-size: 2.5em; font-weight: 800; line-height: 1; letter-spacing: -0.02em; }
    .time-text { font-size: 1.6em; font-weight: 700; margin-top: 6px; letter-spacing: -0.01em; }
    .label-tag {
    ...
    .status-landed-old { background: #0F172A; color: #64748B; border: 1px dashed #334155; box-shadow: none; }
...
with col1:
    ...
    if st.session_state.last_success_time:
        ...
        status_text = "Live" if diff < 25 else "Offline Mode"
...
for f in flights_raw:
    ...
    ac_html = f'<div style="font-size: 0.85em; opacity: 0.6; margin-top: 4px; font-weight:500;">✈️ {ac_model}</div>' if ac_model else ''
    ...
    try:
        ...
        if sch_raw:
            ...
            # Reality Check (Ghost Flight filter)
